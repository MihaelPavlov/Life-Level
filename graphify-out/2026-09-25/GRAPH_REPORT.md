...
2. `LifeLevel.Api.Migrations` - 124 edges
3. `AppDbContext` - 121 edges
4. `LifeLevel.Api.Infrastructure.Persistence` - 108 edges
5. `b()` - 87 edges
6. `b()` - 87 edges
7. `Ok()` - 86 edges
8. `b()` - 82 edges
...
Cohesion: 0.03
Nodes (55): SizedBox, Flexible, ClipRRect, Container, SizedBox, Text, home_palette.dart, home_progress_bar.dart (+47 more)
...
Cohesion: 0.08
Nodes (23): ProviderScope, _activeBoss, bosses, build, _copyWithChestOpened, dart:async, package:flutter/material.dart, package:flutter_riverpod/flutter_riverpod.dart (+15 more)
...
Cohesion: 0.01
Nodes (202): activityClimbing, activityCycling, activityGym, activityHiit, activityHiking, activityMobility, activityMtbCycling, activityRockClimbing (+194 more)
...
Cohesion: 0.04
Nodes (46): Container, FadeTransition, Material, SizedBox, Text, ../constants/app_colors.dart, ../../features/boss/widgets/boss_icon.dart, ../../features/guild/models/guild_models.dart (+38 more)
...
Cohesion: 0.09
Nodes (25): Agi, LogActivityRequest, CancellationToken, DateTime, Guid, int, IReadOnlyList, List (+17 more)
...
Cohesion: 0.12
Nodes (16): base64UrlEncode, dart:math, authorizationUrl, _clientId, connect, ../../../core/api/api_client.dart, dart:convert, dart:math (+8 more)
...
Cohesion: 0.08
Nodes (13): MigrationBuilder, InitialCreate, MigrationBuilder, AddLevelStatBonuses, MigrationBuilder, AddRankThresholdDisplayFields, MigrationBuilder, AddMapTutorialProgress (+5 more)
...
### Community 268 - "encounter_blocker_sheet.dart"
Cohesion: 0.09
Nodes (21): BlockerEncounterData get, BlockerSheet, build, _buildDamageTracker, _buildEstimateCard, _buildHeader, _buildHpBar, _buildInCombat (+13 more)
...
Cohesion: 0.04
Nodes (28): ModelBuilder, InitialCreate, LifeLevel.Api.Migrations, ModelBuilder, LifeLevel.Api.Migrations, AddStepsAndPendingDistance, ModelBuilder, LifeLevel.Api.Migrations (+20 more)

### Community 282 - "AddUserRingItems"
Cohesion: 0.40
...
### Community 364 - "20260328121026_MakeBossEdgeBidirectional.Designer.cs"
Cohesion: 0.40
...
### Community 368 - "20260329141319_AddPhase2QuestStreakLoginReward.Designer.cs"
Cohesion: 0.40
...
Cohesion: 0.38
Nodes (5): CancellationToken, Guid, Task, GearBonuses, IGearBonusReadPort
...
### Community 612 - ".GetWeeklyStatsAsync"
Cohesion: 0.33
...
Cohesion: 0.33
Nodes (5): Backend changes, Context, Mobile changes (`mobile/lib/features/talents/`), Plan - Talents Redesign (Crystal Economy + Hex UI), Verification performed
