...
public static class QuestSeedData
{
    ...
    public static readonly QuestEntity DailyChest = Task("bbbbbbbb-0111-0000-0000-000000000000", "Treasure Hunter", "Open 1 chest on the World Map today.", QuestType.Daily, QuestCategory.ChestsOpened, null, 1, "chest", 102, groupKey: "daily:chest");
    ...
    public static readonly QuestEntity WeeklyChestOne = Task("bbbbbbbb-0221-0000-0000-000000000000", "Treasure Trail", "Open 1 chest on the World Map this week.", QuestType.Weekly, QuestCategory.ChestsOpened, null, 1, "chest", 104, QuestDifficultyTier.Easy, groupKey: "weekly:chests");
    public static readonly QuestEntity WeeklyChestTwo = Task("bbbbbbbb-0222-0000-0000-000000000000", "Vault Seeker", "Open 2 chests on the World Map this week.", QuestType.Weekly, QuestCategory.ChestsOpened, null, 2, "chests", 105, QuestDifficultyTier.Stretch, groupKey: "weekly:chests");
