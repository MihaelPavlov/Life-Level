...
namespace LifeLevel.Api.Migrations
{
    ...
    [Migration("20260328151316_AddMapNodeRewardXp")]
    partial class AddMapNodeRewardXp
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LifeLevel.Api.Domain.Entities.Boss", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("dddddddd-0002-0000-0000-000000000000"),
                            Icon = "🍄",
                            IsMini = true,
                            MaxHp = 200,
                            Name = "Sporebloom Shroom",
                            NodeId = new Guid("bbbbbbbb-0016-0000-0000-000000000000"),
                            RewardXp = 300,
                            TimerDays = 3
                        },
                        new
                        {
                            Id = new Guid("dddddddd-0003-0000-0000-000000000000"),
                            Icon = "❄️",
                            IsMini = true,
                            MaxHp = 350,
                            Name = "Frost Stalker",
                            NodeId = new Guid("bbbbbbbb-0017-0000-0000-000000000000"),
                            RewardXp = 500,
                            TimerDays = 3
                        });
                });
            ...
            modelBuilder.Entity("LifeLevel.Api.Domain.Entities.MapEdge", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("cccccccc-0016-0000-0000-000000000000"),
                            DistanceKm = 4.0,
                            FromNodeId = new Guid("bbbbbbbb-0002-0000-0000-000000000000"),
                            IsBidirectional = true,
                            ToNodeId = new Guid("bbbbbbbb-0016-0000-0000-000000000000")
                        },
                        new
                        {
                            Id = new Guid("cccccccc-0017-0000-0000-000000000000"),
                            DistanceKm = 2.5,
                            FromNodeId = new Guid("bbbbbbbb-0008-0000-0000-000000000000"),
                            IsBidirectional = true,
                            ToNodeId = new Guid("bbbbbbbb-0017-0000-0000-000000000000")
                        });
                });
            ...
            modelBuilder.Entity("LifeLevel.Api.Domain.Entities.MapNode", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("bbbbbbbb-0016-0000-0000-000000000000"),
                            Description = "Strange fungi pulse with an eerie glow. Something lurks within.",
                            Icon = "🍄",
                            IsHidden = false,
                            IsStartNode = false,
                            LevelRequirement = 2,
                        ...
                        new
                        {
                            Id = new Guid("bbbbbbbb-0017-0000-0000-000000000000"),
                            Description = "Icy winds howl from the cave mouth. A predator has made its home here.",
                            Icon = "❄️",
                            IsHidden = false,
                            IsStartNode = false,
                            LevelRequirement = 9,
