...
namespace LifeLevel.Api.Migrations
{
    ...
    [Migration("20260925105518_AddProgressiveTalentDrawCosts")]
    partial class AddProgressiveTalentDrawCosts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LifeLevel.Modules.Adventure.Encounters.Domain.Entities.Boss", b =>
                {
                    ...
                    b.Property<int>("CombatVersion")
                        .HasColumnType("integer");

                    b.Property<int>("CounterattackDamage")
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("SuppressExpiry")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("LifeLevel.Modules.Adventure.Encounters.Domain.Entities.BossCombatTurn", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<double>("BossActiveDamagePct")
                        .HasColumnType("double precision");

                    b.Property<int>("BossArmor")
                        .HasColumnType("integer");

                    b.Property<int>("BossCounterattackRaw")
                        .HasColumnType("integer");

                    b.Property<bool>("BossDefeated")
                        .HasColumnType("boolean");

                    b.Property<int>("BossHpAfter")
                        .HasColumnType("integer");

                    b.Property<double>("BossMitigation")
                        .HasColumnType("double precision");
                    ...
                    b.Property<bool>("PlayerDefeated")
                        .HasColumnType("boolean");

                    b.Property<int>("PlayerHpAfter")
                        .HasColumnType("integer");

                    b.Property<double>("PlayerMitigation")
                        .HasColumnType("double precision");

                    b.Property<int>("Power")
                        .HasColumnType("integer");

                    b.Property<int>("RawWorkoutDamage")
                        .HasColumnType("integer");
                    ...
                    b.Property<Guid>("UserBossStateId")
                        .HasColumnType("uuid");

                    b.HasKey("Id");

                    b.HasIndex("UserBossStateId", "ActivityId")
                        .IsUnique();

                    b.ToTable("BossCombatTurns");
                });
            ...
            modelBuilder.Entity("LifeLevel.Modules.Adventure.Encounters.Domain.Entities.UserBossState", b =>
                {
                    ...
                    b.Property<int>("CounterattackDamageSnapshot")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LifeLevel.Modules.Character.Domain.Entities.Character", b =>
                {
                    ...
                    b.Property<int>("TutorialTopicsSeen")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LifeLevel.Modules.Character.Domain.Entities.LevelStatBonus", b =>
                {
                    ...
                    b.ToTable("LevelStatBonuses");
                });

            modelBuilder.Entity("LifeLevel.Modules.Character.Domain.Entities.LevelTitleGrant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LifeLevel.Modules.Items.Domain.Entities.Item", b =>
                {
                    ...
                    b.Property<string>("GearImageUrl")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
                    ...
                    b.Property<string>("InventoryIconUrl")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
            ...
            modelBuilder.Entity("LifeLevel.Modules.Items.Domain.Entities.ItemDropRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("TriggerParameters")
                        .IsRequired()
                        .HasMaxLength(2000)
            ...
            modelBuilder.Entity("LifeLevel.Modules.Talents.Domain.Entities.TalentDrawEntry", b =>
                {
                    ...
                    b.Property<int>("TalentPointsBeforeDraw")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LifeLevel.Modules.WorldZone.Domain.Entities.Region", b =>
                {
                    ...
                    b.Property<string>("TrailBackgroundImageUrl")
                        .HasMaxLength(2048)
                        .HasColumnType("character varying(2048)");
            ...
            modelBuilder.Entity("LifeLevel.Modules.WorldZone.Domain.Entities.UserPathChoice", b =>
                {
                    ...
                    b.Property<Guid>("ChosenBranchZoneId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("CrossroadsZoneId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UserId", "CrossroadsZoneId")
                        .IsUnique();
            ...
            modelBuilder.Entity("LifeLevel.Modules.WorldZone.Domain.Entities.UserWorldChestState", b =>
                {
                    ...
                    b.HasIndex("UserId", "WorldZoneId")
                        .IsUnique();

                    b.ToTable("UserWorldChestStates");
                });

            modelBuilder.Entity("LifeLevel.Modules.WorldZone.Domain.Entities.UserWorldDungeonFloorState", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("UserWorldDungeonFloorStates");
                });

            modelBuilder.Entity("LifeLevel.Modules.WorldZone.Domain.Entities.UserWorldDungeonState", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<int>("CurrentFloorOrdinal")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("UserWorldDungeonStates");
                });
            ...
            modelBuilder.Entity("LifeLevel.Modules.WorldZone.Domain.Entities.WorldZone", b =>
                {
                    ...
                    b.Property<int?>("BossCounterattackDamage")
                        .HasColumnType("integer");

                    b.Property<int?>("BossMaxHp")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("ChestRewardDescription")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)");

                    b.Property<int?>("ChestRewardXp")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LifeLevel.Modules.WorldZone.Domain.Entities.WorldZoneDungeonFloor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("WorldZoneId", "Ordinal")
                        .IsUnique();

                    b.ToTable("WorldZoneDungeonFloors");
                });
            ...
            modelBuilder.Entity("LifeLevel.Modules.Adventure.Encounters.Domain.Entities.BossCombatTurn", b =>
                {
                    b.HasOne("LifeLevel.Modules.Adventure.Encounters.Domain.Entities.UserBossState", "UserBossState")
                        .WithMany("CombatTurns")
                        .HasForeignKey("UserBossStateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("UserBossState");
                });
